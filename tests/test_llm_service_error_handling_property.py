...
@pytest.mark.asyncio
async def test_property_5_llm_error_handling(
    num_articles,
    num_api_failures
):
    """
    ...
    assert failed_count == num_api_failures, \
        f"Expected {num_api_failures} failed articles, got {failed_count}"
    assert success_count == (num_articles - num_api_failures), \
...
@pytest.mark.asyncio
async def test_property_5_llm_error_handling_summary_failures(
    num_articles,
    num_summary_failures
):
    """
