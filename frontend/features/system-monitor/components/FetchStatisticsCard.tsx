      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="space-y-2 animate-in slide-in-from-left-4 duration-500 delay-500">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <FileText className="h-4 w-4 text-muted-foreground transition-transform duration-200 hover:scale-110" />
                <span className="text-sm font-medium">處理文章數</span>
              </div>
              <span className="text-2xl font-bold transition-all duration-200 hover:scale-110 hover:text-primary">
          ...
          <div className="space-y-3 animate-in slide-in-from-right-4 duration-500 delay-600">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-muted-foreground transition-transform duration-200 hover:scale-110" />
                <span className="text-sm font-medium">成功率</span>
              </div>
              <span
                className={`text-2xl font-bold transition-all duration-200 hover:scale-110 ${successRateColor}`}
              >
          ...
          <div className="space-y-2 animate-in slide-in-from-left-4 duration-500 delay-1000">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-muted-foreground transition-transform duration-200 hover:scale-110" />
                <span className="text-sm font-medium">平均處理時間</span>
              </div>
              <span className="text-2xl font-bold font-mono transition-all duration-200 hover:scale-110 hover:text-primary">
                {processingTime}
              </span>
            </div>
          ...
          <div className="space-y-2 animate-in slide-in-from-right-4 duration-500 delay-1200">
            <div className="flex items-center justify-between animate-in slide-in-from-left-2 duration-300 delay-1400">
              ...
              <span className="text-lg font-semibold transition-all duration-200 hover:scale-110">
            ...
            <div className="flex items-center justify-between animate-in slide-in-from-right-2 duration-300 delay-1500">
              ...
              <span className="text-lg font-semibold text-red-600 dark:text-red-400 transition-all duration-200 hover:scale-110">
