          ...
          },
          {
            ...
            value:
              process.env.NODE_ENV === 'development'
                ? `default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' http://localhost:* http: https: ${process.env.API_BASE_URL || ''} ${process.env.NEXT_PUBLIC_API_BASE_URL || ''}; manifest-src 'self';`
