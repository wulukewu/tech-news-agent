    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 1023px) {
          .kg-page { position: fixed; top: ${headerHeight + 2}px; left: 0; right: 0; bottom: 0; height: auto; z-index: 30; background: var(--background); padding-bottom: calc(env(safe-area-inset-bottom, 0px) + 20px); }
        }
      `}</style>
