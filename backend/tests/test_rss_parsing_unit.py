...
class TestRSSParsing:
    ...
    def test_timezone_information_preserved(self):
        ...
        assert parsed_date.tzinfo == timezone.utc, "Timezone should be UTC"
    ...
    def test_special_characters_in_url(self):
        ...
        for url in special_urls:
            ...
            assert str(article.url) == url, \
                f"Special characters should be preserved in URL: {url}"
    ...
    def test_parse_date_fallback_to_current_time(self):
        ...
        entry = {
            'title': 'Article without any date fields'
        }
    ...
    async def test_process_single_feed_creates_article_schemas(self):
        ...
        recent_date1 = datetime.now(timezone.utc)
        recent_date2 = datetime.now(timezone.utc)
