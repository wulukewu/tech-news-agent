...
class TestBatchSubscribe:
    ...
    async def test_batch_subscribe_all_success(self, subscription_service, mock_supabase_client):
        ...
        mock_supabase_client.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.return_value.data = [{'id': str(feed_ids[0])}]
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_all_fail_invalid_feeds(self, subscription_service, mock_supabase_client):
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_partial_success(self, subscription_service, mock_supabase_client):
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_duplicate_subscriptions(self, subscription_service, mock_supabase_client):
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_database_error_on_insert(self, subscription_service, mock_supabase_client):
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_mixed_valid_invalid_feeds(self, subscription_service, mock_supabase_client):
    ...
    async def test_batch_subscribe_large_batch(self, subscription_service, mock_supabase_client):
        ...
        mock_supabase_client.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.side_effect = responses
        mock_supabase_client.table.return_value.insert.return_value.execute.return_value = MagicMock()
    ...
    @pytest.mark.asyncio
    async def test_batch_subscribe_returns_correct_counts(self, subscription_service, mock_supabase_client):
