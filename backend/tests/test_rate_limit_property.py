...
def test_rate_limit_per_ip(client):
    ...
    **Validates: Requirements 15.1, 15.2**
    ...
    assert any(r.status_code == 200 for r in ip1_responses), \
        "IP1 should have successful requests"
    assert any(r.status_code == 200 for r in ip2_responses), \
        "IP2 should have successful requests"
