...
class TestSeedFeedsDuplicateHandling:
    ...
    def test_duplicate_url_is_skipped(self, mock_create_client, mock_getenv, mock_load_dotenv, capsys):
        """
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_multiple_duplicates_are_all_skipped(self, mock_create_client, mock_getenv, mock_load_dotenv, capsys):
        """
...
class TestSeedFeedsConnectionFailure:
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_connection_failure_raises_descriptive_error(self, mock_create_client, mock_getenv, mock_load_dotenv):
        """
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_network_error_during_insert_raises_descriptive_error(self, mock_create_client, mock_getenv, mock_load_dotenv):
        """
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_invalid_credentials_raises_descriptive_error(self, mock_create_client, mock_getenv, mock_load_dotenv):
        """
...
class TestSeedFeedsSuccessfulExecution:
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_successful_seed_prints_summary(self, mock_create_client, mock_getenv, mock_load_dotenv, capsys):
        """
    ...
    @patch('seed_feeds.os.getenv')
    @patch('seed_feeds.create_client')
    def test_mixed_success_and_duplicates_prints_both_counts(self, mock_create_client, mock_getenv, mock_load_dotenv, capsys):
        """
