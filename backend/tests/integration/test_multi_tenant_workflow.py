...
from app.schemas.article import ReadingListItem, Subscription
    ...
    async def test_concurrent_subscription_operations(self):
        ...
        **Validates: Requirement 13 (並發操作處理)
        ...
        async def subscribe_user(user_id: str, feed_id: str):
            ...
            return {"user_id": user_id, "feed_id": feed_id, "success": True}
        ...
        results = await asyncio.gather(
            *[subscribe_user(user, feed) for user, feed in zip(users, feeds, strict=False)]
        )
    ...
    def test_error_logging_with_context(self):
        ...
        **Validates: Requirement 17.4**
        ...
        log_entry = {
            ...
            "user_id": "123456789",
            "context": {"command": "add_feed", "feed_url": "https://example.com/feed.xml"},
            "timestamp": datetime.now(UTC).isoformat(),
        }
