...
class TestReadingListSchema:
    ...
    def test_reading_list_columns_exist(self, test_supabase_client: Client, test_user, test_article):
    ...
    def test_unique_constraint_user_article(self, test_supabase_client: Client, test_user, test_article):
        ...
        data['rating'] = 5
        response2 = test_supabase_client.table('reading_list')\
    ...
    @given(
        status=st.sampled_from(['Unread', 'Read', 'Archived'])
    )
    def test_status_check_constraint_valid(self, test_supabase_client: Client, test_user, test_article, status):
    ...
    def test_status_check_constraint_invalid(self, test_supabase_client: Client, test_user, test_article):
    ...
    def test_rating_check_constraint_valid(self, test_supabase_client: Client, test_user, test_article, rating):
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    @given(
        rating=st.integers().filter(lambda x: x < 1 or x > 5)
    )
    def test_rating_check_constraint_invalid(self, test_supabase_client: Client, test_user, test_article, rating):
    ...
    def test_cascade_delete_user(self, test_supabase_client: Client, test_article):
        ...
        check_response = test_supabase_client.table('reading_list')\
            .select('*')\
