...
def check_indexes():
    ...
    try:
        ...
        # Test user_id query
        test1 = service.client.table('reading_list')\
            .select('*')\
        ...
        test2 = service.client.table('reading_list')\
            .select('*')\
            .eq('user_id', '00000000-0000-0000-0000-000000000000')\
            .eq('status', 'Unread')\
            .limit(1)\
        ...
        test3 = service.client.table('reading_list')\
            .select('*')\
            .eq('user_id', '00000000-0000-0000-0000-000000000000')\
        ...
        test4 = service.client.table('reading_list')\
            .select('*')\
            .eq('user_id', '00000000-0000-0000-0000-000000000000')\
        ...
        print("2. Run: SELECT indexname, indexdef FROM pg_indexes WHERE tablename = 'reading_list';")
