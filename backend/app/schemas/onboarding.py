...
class OnboardingStatus(BaseModel):
    ...
    tooltip_tour_completed: bool = Field(
        ..., description="Whether user has completed the tooltip tour"
    )
    should_show_onboarding: bool = Field(
        ..., description="Whether the onboarding modal should be displayed to the user"
    )
...
class UpdateOnboardingProgressRequest(BaseModel):
    ...
    model_config = ConfigDict(json_schema_extra={"example": {"step": "welcome", "completed": True}})
...
class UserPreferences(BaseModel):
    ...
    tooltip_tour_completed: bool = Field(
        default=False, description="Whether user has completed the tooltip tour"
    )
    tooltip_tour_skipped: bool = Field(
        default=False, description="Whether user skipped the tooltip tour"
    )
