...
class LogAnalyticsEventRequest(BaseModel):
    ...
    """
    event_type: str = Field(..., description="Type of event (onboarding_started, step_completed, etc.)")
    event_data: Dict[str, Any] = Field(default_factory=dict, description="Additional event metadata")
